 ...
 * @param parameters.options.pathPrefix Prefix for bundle path
 * @param parameters.options.hasFlexBundleVersion true if minUI5Version >= 1.73 than
 *															create flexibility-bundle.json
 * @param [parameters.existingFlexBundle] Object with existing flexibility-bundle.json
 * 															to merge with new changes
 * @returns Promise resolving with flex changes bundle resources
 */
export default function ({resources, options: {pathPrefix, hasFlexBundleVersion}, existingFlexBundle = {}}: object) {
	 ...
	 *
	 * @param changesContent Array of resources files
	 * @returns Json sting of changes and control variants
	 */
	function sortAndStringifyInFlexFormat(changesContent: any[]) {
	 ...
	 *
	 * @param newFlexBundle Object with new content of flexibility-bundle.json
	 * @returns Object with merged content of new and existing flexibility-bundle.json
	 */
