 ...
 * @param options.includeConditionalDependencies whether or not to include optional dependencies
 * @returns
 */
async function createDependencyGraph(pool: ResourcePool, roots: any[], options: {
