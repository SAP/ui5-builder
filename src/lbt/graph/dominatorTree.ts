 ...
 *
 * @param graph Graph to calculate the DOM tree for
 * @param graph.nodes Nodes of the dependency graph
 * @param graph.n0 Artificial root node
 * @returns Root node of the dominator tree.
 */
