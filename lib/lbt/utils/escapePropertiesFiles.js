...
module.exports = async function(resource) {
	const propertiesSourceFileEncoding = resource.getProject()
			&& resource.getProject().resources
			&& resource.getProject().resources.configuration
			&& resource.getProject().resources.configuration.propertiesSourceFileEncoding;
	...
	return fileContent.toString(encoding);
};
