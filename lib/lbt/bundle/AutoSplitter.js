		...
		if ( resource != null ) {
			...
			if ( /\.js$/.test(module) ) {
				...
				*/
				...
				const encoding = resource.getProject() && resource.getProject().resources.propertiesFileEncoding;

				await nonAsciiEscaper({
					resources: [resource.resource],
					options: {
						encoding: nonAsciiEscaper.getEncodingFromNiceName(encoding || "ISO-8859-1")
					}
				});
