...
function getSapUiCoreBunDef(name, filters, preload=false) {
			...
			p = Promise.all([
				moduleBundler({
					options: {
						...
						bundleDefinition: getSapUiCoreBunDef("sap-ui-core.js", filters, true)
					},
					resources
				}),
				moduleBundler({
					options: {
						...
						bundleDefinition: getSapUiCoreBunDef("sap-ui-core-dbg.js", filters)
					},
					resources
				}),
				moduleBundler({
					options: {
						...
						bundleDefinition: (function() {
							let bundleDef = getSapUiCoreBunDef("sap-ui-core-nojQuery.js", filters, true);
							// provided section is required in sap-ui-core-nojQuery.js
							bundleDef.sections.unshift(providedSection);
							return bundleDef;
						})()
					},
					resources
				...
				moduleBundler({
					options: {
						...
						bundleDefinition: (function() {
							let bundleDef = getSapUiCoreBunDef("sap-ui-core-nojQuery-dbg.js", filters);
							// provided section is required in sap-ui-core-nojQuery-dbg.js
							bundleDef.sections.unshift(providedSection);
							return bundleDef;
						})()
					},
