...
function getNojQueryBunDef(name, filters, preload=false) {
	const bundleDefinition = {
		name,
		sections: []
	};

	// add provided section
	bundleDefinition.sections.push({
		mode: "provided",
		filters: [
			"jquery-ui-core.js",
			...
			p = Promise.all([
				...
				moduleBundler({
					options: {
						...
						bundleDefinition: getNojQueryBunDef("sap-ui-core-nojQuery.js", filters, true)
					},
					resources
				}),
				moduleBundler({
					options: {
						...
						bundleDefinition: getNojQueryBunDef("sap-ui-core-nojQuery-dbg.js", filters)
					},
					resources
				}),
			]).then((results) => {
