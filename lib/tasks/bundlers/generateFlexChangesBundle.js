...
export default async function({workspace, taskUtil, options = {}}) {
	...
	function updateJson(data, hasFlexibilityBundle = false) {
	...
	async function updateFLdependency(hasFlexibilityBundle = false) {
		...
		updateJson(manifestContent, hasFlexibilityBundle);
