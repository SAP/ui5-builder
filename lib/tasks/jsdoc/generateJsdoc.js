 ...
 * @param { @ui5/builder/tasks/generateJsdoc~GenerateJsdocOptions} parameters.options Options
...
export default async function generateJsdoc({
	...
	/** @type { @ui5/builder/tasks/generateJsdoc~GenerateJsdocOptions} */ (options);
