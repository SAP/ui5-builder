 ...
 * @param {string|string[]} parameters.options.pattern Pattern to locate the files to be processed
...
const generateJsdoc = async function(
	{buildContext, workspace, dependencies, options: {pattern, projectName, namespace, version}} = {}
) {
