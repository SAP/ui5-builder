...
export default async function({
	...
	options: {
		projectName, inputPattern, librariesPattern, themesPattern, compress, cssVariables, useWorkers = true
	}
}) {
	...
	// All the relevant (less) resources need to be made available for the less parser within the workerpool
