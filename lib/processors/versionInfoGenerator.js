 ...
 * @property { @ui5/builder/processors/versionInfoGenerator~ManifestLibraries} libs the dependencies, e.g.
 ...
 * @returns {Promise<@ui5/builder/processors/versionInfoGenerator~ManifestInfo>}
 */
...
class DependencyInfo {
	/**
	 *
	 * @param { @ui5/builder/processors/versionInfoGenerator~ManifestLibraries} libs
	 ...
	 * @returns { @ui5/builder/processors/versionInfoGenerator~ManifestLibraries} resolved libraries
	 */
 ...
 * @property { @ui5/builder/processors/versionInfoGenerator~ArtifactInfo[]} embeds The embedded artifact infos
 */
 ...
 *
 * @param { @ui5/builder/processors/versionInfoGenerator~LibraryInfo} libraryInfo
 * @returns {Promise<@ui5/builder/processors/versionInfoGenerator~ArtifactInfo|undefined>}
 */
 ...
 * @param { @ui5/builder/processors/versionInfoGenerator~LibraryInfo[]} parameters.options.libraryInfos Array of
