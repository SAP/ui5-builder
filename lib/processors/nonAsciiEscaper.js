 ...
 *
 * @example
 * const encoding = nonAsciiEscaper.getEncodingFromNiceName("ISO-8859-1");
 ...
 * @param {string} [parameters.options.encoding="utf8"] resource file encoding (node.js based encodings). Use #getEncodingFromNiceName to get the encoding string
 ...
 */
module.exports.getEncodingFromNiceName = function(encoding) {
