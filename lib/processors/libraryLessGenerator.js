...
const BASE_LESS_PATTERN = /^sap\/ui\/core\/themes\/([^/]+)\/base\.less$/;
const GLOBAL_LESS_PATTERN = /sap\/ui\/core\/themes\/([^/]+)\/global\.(less|css)$/;

const pathToUI5Root = "TODO";
...
class LibraryLessGenerator {
	...
	async resolveLessImport(importMatch, resolvedFilePath) {
		...
		if (baseLessMatch) {
			...
			const baseLessPath = pathToUI5Root + "../Base/baseLib/" + baseLessThemeName + "/base.less";
			importMatch.content =
