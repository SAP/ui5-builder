...
export class ThemeBuilder {
	 ...
	 *
	 * @public
	 * @param {fs|@ui5/fs/fsInterface} fs Node fs or custom
	 * 		[fs interface]{@link @ui5/fs/fsInterface}
	 */
	constructor({fs}) {
 ...
 * @param {fs|@ui5/fs/fsInterface} parameters.fs Node fs or custom
 *   [fs interface]{@link @ui5/fs/fsInterface}
 * @param { @ui5/builder/processors/ThemeBuilder~ThemeBuilderOptions} [parameters.options] Options
...
export default async function({
	...
	const {compress, cssVariables} = /** @type { @ui5/builder/processors/ThemeBuilder~ThemeBuilderOptions} */ (options);
