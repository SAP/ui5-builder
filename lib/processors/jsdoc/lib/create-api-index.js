...
// auto execute the index creation, if this module is the executed script (not used in grunt tooling)
if ( process.argv.length > 1 && /create-api-index.js$/.test(process.argv[1]) ) {
