...
/* global env: true */
/* eslint strict: [2, "global"], max-len: ["warn", 180],  no-console: "off", guard-for-in: "off", no-invalid-this: "off", no-useless-escape: "off" */
	...
	if ( files && files.length ) {
		files.forEach(function(localFileName) {
			try {
				...
				error("failed to load symbols from  " + localFileName + ": " + (e.message || e));
			}
		});
	}
}
