 ...
 * filters:
 * - "some/path/to/module"
 * - "some/other/path/to/module"
 * - "!some/path/to/module/to/be/excluded"
 * - "!some/other/path/to/module/to/be/excluded"
 ...
 * @property {boolean} [declareRawModules=true] Whether raw modules should be declared after jQuery.sap.global became available
 * @property {boolean} [sort=true] Whether the modules should be sorted by their dependencies
 * @property {boolean} [avoidLazyParsing=false] Whether sap.ui.define factory functions and preload-generated wrapper functions should be wrapped with the parenthesis to avoid lazy parsing in V8 and Chakra
 */
