 ...
 * @property {boolean} [decorateBootstrapModule=false] If set to 'false', bootable module bundles won't be decorated
 ...
 * @property {boolean} [legacyBundleFormat=false] Whether to use the legacy jQuery.sap.registerPreloadedModules
 *	 API instead of sap.ui.require.preload
 */
