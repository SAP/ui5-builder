 ...
 *	<li>
		 <code>preload</code>: A preload section packages resources that should be stored in the preload cache in the client.
			They can embed any textual resource type (JavaScript, CSS and Theme-Parameter files) that the bundling supports.
 ...
 * 		A pattern either contains of trailing slashes '/', single '*' or double asterisks '**' which denote an arbitrary number of characters or folder names.
