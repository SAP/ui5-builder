...
const APP_DESCRIPTOR_V12 = new Version("1.11.0");
...
async function createManifest(
	...
	function createSapCloud() {
		const sapCloudElement = findChild(manifestAppData, "sap.cloud");
		if ( sapCloudElement ) {
			return {
				_version: sectionVersion(APP_DESCRIPTOR_V12),
				public: !!getChildTextContent(sapCloudElement, "public"),
				service: getChildTextContent(sapCloudElement, "service")
			};
		}
	}
