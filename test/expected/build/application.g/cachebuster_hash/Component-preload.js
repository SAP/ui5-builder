...
sap.ui.define(["sap/ui/core/UIComponent"],function(n){return n.extend("application.g.Component",{metadata:{manifest:"json"}})});
},
...
sap.ui.define(["sap/ui/core/UIComponent"],function(n){return n.extend("application.g.subcomponentA.Component",{metadata:{manifest:"json"}})});
},
...
sap.ui.define(["sap/ui/core/UIComponent"],function(n){return n.extend("application.g.subcomponentB.Component",{metadata:{manifest:"json"}})});
},
