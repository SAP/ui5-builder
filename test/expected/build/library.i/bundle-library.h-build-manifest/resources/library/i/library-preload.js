 ...
 */
sap.ui.predefine("library/i/library", ["sap/ui/core/Core"],function(i){sap.ui.getCore().initLibrary({name:"library.i",version:"1.0.0",dependencies:["sap.ui.core"],types:["library.i.ButtonType","library.i.DialogType"],interfaces:["library.i.IContent"],controls:["library.i.Button","library.i.CheckBox","library.i.Dialog","library.i.Input","library.i.Label","library.i.Link","library.i.Menu","library.i.Text"],elements:["library.i.MenuItem"]});return thisLib});
