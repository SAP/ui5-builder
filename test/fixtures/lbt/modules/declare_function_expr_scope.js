...
(function($1, window) {
	...
	(function() {
		...
		let z = jQuery.sap.require("nested.scope.require.var");
		z = jQuery.sap.require("nested.scope.require.assign");
		let zs = sap.ui.requireSync("nested/scope/requireSync/var");
	...
	(function() {
		...
		let z = jQuery.sap.require("nested.scope2.require.var");
		z = jQuery.sap.require("nested.scope2.require.assign");
		let zs = sap.ui.requireSync("nested/scope2/requireSync/var");
